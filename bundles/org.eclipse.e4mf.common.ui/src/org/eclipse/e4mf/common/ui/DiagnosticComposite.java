 ...
 */
package org.eclipse.e4mf.common.ui;
	...
	protected ILabelProvider createLabelProvider() {
		return new LabelProvider() {
			...
			public Image getImage(Object element) {
				...
				switch (diagnostic.getSeverity()) {
				case Diagnostic.ERROR:
						return pool.getImageUnchecked(WorkbenchResourceProvider.IMG_OBJS_ERROR_TSK);
					// return sharedImages
					// .getImage(ISharedImages.IMG_OBJS_ERROR_TSK);
				case Diagnostic.CANCEL:
				case Diagnostic.WARNING:
					return pool.getImageUnchecked(WorkbenchResourceProvider.IMG_OBJS_WARN_TSK);
//					return sharedImages
//							.getImage(ISharedImages.IMG_OBJS_WARN_TSK);
				case Diagnostic.OK:
				case Diagnostic.INFO:
					return pool.getImageUnchecked(WorkbenchResourceProvider.IMG_OBJS_INFO_TSK);
					// return sharedImages
