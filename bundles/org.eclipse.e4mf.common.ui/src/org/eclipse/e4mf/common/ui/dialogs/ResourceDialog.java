 ...
 */
package org.eclipse.e4mf.common.ui.dialogs;
...
import org.eclipse.e4mf.common.ui.CommonUIPlugin;
import org.eclipse.emf.common.EMFPlugin;
import org.eclipse.emf.common.util.URI;

/**
 * Instances of this class allow a user to specify one or more URIs identifying resources.
 * The dialog includes buttons that allow the file system or workspace to be browsed, so
 * that the URI can be automatically filled based on the selected file.
 * <p>
 * Subclasses are encouraged to override {@link #processResources}, where they can process
 * the specified URIs.
 * @since 2.2.0
 */
public class ResourceDialog extends Dialog
{
   ...
   * @param style {@link SWT SWT style bits}, indicating whether {@link SWT#OPEN existing (<code>SWT.OPEN</code>)}
   *   or {@link SWT#SAVE new <code>(SWT.SAVE)</code>} resources are to be specified and, in the former case, whether 
   *   {@link SWT#SINGLE single (<code>SWT.SINGLE</code>)} or {@link SWT#MULTI multiple (<code>SWT.MULTI</code>)}.
  ...
  /**
   * Called by {@link #okPressed} to handle the specified URIs, this implementation simply returns true, allowing
   ...
   * @return <code>true</code> if the dialog can be closed, <code>false</code> if URI(s) must be re-entered 
   */
