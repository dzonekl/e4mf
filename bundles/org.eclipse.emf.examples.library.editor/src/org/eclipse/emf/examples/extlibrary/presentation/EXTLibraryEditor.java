...
public class EXTLibraryEditor
	 ...
	 * @generated
	 */
	public static final List<String> FILE_EXTENSION_FILTERS = prefixExtensions(EXTLibraryModelWizard.FILE_EXTENSIONS, "*."); //$NON-NLS-1$
	...
	public void doSaveAs() {
		...
		String[] files = EXTLibraryEditorAdvisor.openFilePathDialog(getSite().getShell(), SWT.SAVE, filters);
		if (files.length > 0) {
