 ...
 */
package org.eclipse.e4mf.edit.ui.dnd;
...
public class EditingDomainViewerDropAdapter extends DropTargetAdapter
{
   ...
   * {@link org.eclipse.e4mf.common.ui.viewer.ExtendedTableTreeViewer.ExtendedTableTreeItem}.
   */
  @SuppressWarnings("deprecation")
  protected Object extractDropTarget(Widget item)
  {
    if (item == null) return null;
    return item.getData(org.eclipse.e4mf.common.ui.viewer.ExtendedTableTreeViewer.ITEM_ID) instanceof Item ?
      ((Item)item.getData(org.eclipse.e4mf.common.ui.viewer.ExtendedTableTreeViewer.ITEM_ID)).getData() :
      item.getData();
  }
