...
@Creatable
public class EXTLibraryModelWizard extends Wizard {
	/**
	...
	public static final List<String> FILE_EXTENSIONS = Collections
			.unmodifiableList(Arrays
					.asList(EXTLibraryEditorPlugin.INSTANCE
							.getString("_UI_EXTLibraryEditorFilenameExtensions").split("\\s*,\\s*"))); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @generated
	 */
	public static final String FORMATTED_FILE_EXTENSIONS = EXTLibraryEditorPlugin.INSTANCE
			.getString("_UI_EXTLibraryEditorFilenameExtensions").replaceAll("\\s*,\\s*", ", "); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	 ...
	 * @generated
	 */
	protected EXTLibraryFactory extLibraryFactory = extLibraryPackage
...
//		setWindowTitle(EXTLibraryEditorPlugin.INSTANCE
//				.getString("_UI_Wizard_label")); //$NON-NLS-1$
//		setDefaultPageImageDescriptor(ExtendedImageRegistry.INSTANCE
//				.getImageDescriptor(EXTLibraryEditorPlugin.INSTANCE
//						.getImage("full/wizban/NewEXTLibrary"))); //$NON-NLS-1$
//	}
	...
	protected EObject createInitialModel() {
		EClass eClass = (EClass) extLibraryPackage
		...
		try {
			...
			if (new File(fileURI.toFileString()).exists()) {
				if (!MessageDialog
						.openQuestion(
								getShell(),
								EXTLibraryEditorPlugin.INSTANCE
										.getString("_UI_Question_title"), //$NON-NLS-1$
								EXTLibraryEditorPlugin.INSTANCE
										.getString(
												"_WARN_FileConflict", new String[] { fileURI.toFileString() }))) //$NON-NLS-1$
				{
				...
				public void run(IProgressMonitor progressMonitor) {
					try {
						...
						Resource resource = resourceSet.createResource(fileURI,
								EXTLibraryPackage.eCONTENT_TYPE);
			...
			// CB Use support service.
			// return EXTLibraryEditorAdvisor.openEditor(workbench, fileURI);

			return support.openEditor(fileURI);
	 ...
	 * @generated
	 */
	public class EXTLibraryModelWizardInitialObjectCreationPage extends
			WizardPage {
		/**
		 * <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		...
		public void createControl(Composite parent) {
			...
			{
				resourceURILabel.setText(EXTLibraryEditorPlugin.INSTANCE
						.getString("_UI_File_label")); //$NON-NLS-1$
			...
			resourceURIBrowseFileSystemButton
					.setText(EXTLibraryEditorPlugin.INSTANCE
			...
			resourceURIBrowseFileSystemButton
					.addSelectionListener(new SelectionAdapter() {
						...
						public void widgetSelected(SelectionEvent event) {
							String[] filters = EXTLibraryEditor.FILE_EXTENSION_FILTERS
									.toArray(new String[EXTLibraryEditor.FILE_EXTENSION_FILTERS
											.size()]);
							String[] files = support.openFilePathDialog(
			...
			{
				containerLabel.setText(EXTLibraryEditorPlugin.INSTANCE
			...
			{
				encodingLabel.setText(EXTLibraryEditorPlugin.INSTANCE
		...
		protected boolean validatePage() {
			...
			if (extension == null || !FILE_EXTENSIONS.contains(extension)) {
				...
				setErrorMessage(EXTLibraryEditorPlugin.INSTANCE.getString(key,
	...
	public void addPages() {
		initialObjectCreationPage = new EXTLibraryModelWizardInitialObjectCreationPage(
				"Whatever2"); //$NON-NLS-1$
		initialObjectCreationPage.setTitle(EXTLibraryEditorPlugin.INSTANCE
				.getString("_UI_EXTLibraryModelWizard_label")); //$NON-NLS-1$
		initialObjectCreationPage
				.setDescription(EXTLibraryEditorPlugin.INSTANCE
